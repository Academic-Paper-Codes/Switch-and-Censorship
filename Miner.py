...
#         try:
#             # 将签名从十六进制字符串转换为字节数组
#             message_data = f"{transaction['message']}|{transaction['switch']}|{transaction['block_number']}|{transaction['chameleon_random']}".encode()
...
#     # Example Blockchain and TransactionPool setup (you should have these classes defined elsewhere)
#     class Blockchain:
#         def __init__(self):
#             self.blocks = []
#
...
#
#     # Example of initializing the blockchain and transaction pool
#     blockchain = Blockchain()
#     transaction_pool = TransactionPool()
#
#     # Example of generating keys for verification (using pre-generated public/private keys)
...
#
#     # Example of creating a Miner object
#     miner = Miner(blockchain, transaction_pool, verbose=True)
#
#     # Example transaction (replace with actual transactions)
#     transaction = {
#         "message": "Sample transaction data",
#         "switch": "calculated_switch_hash",  # This should be the chameleon hash
#         "block_number": 1,
...
#
#     # Finalize transactions and add block to blockchain
#     miner.finalize_transactions(public_key, "secret_key")
